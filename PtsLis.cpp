            ...
            if (tmp_string == "CP") {
                ...
                for (size_t i=0; i<N; i++){
                    ...
                    if (i==0) {
                        ...
                        // check if the control point should be fixed in optimization
                        for (size_t j=0; j<control_points.size(); j++){
                            if (tmp_pt.getFlag() == control_points[j].getFlag()){
...
void PtsLis::printFile() {
    ...
    for (size_t i=0; i<bsplines.size(); i++) {
        ...
        myOutFile << bsplines[i].getPoint(0).getFlag() << " "
                  << bsplines[i].getPoint(bsplines[i].getNumPoints()-1).getFlag() << " "
